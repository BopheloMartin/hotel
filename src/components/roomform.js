        ...
        <div>
            <Container>
                <div className='roomform'>
                    <Carousel>
                        <Carousel.Item>
                            <img className="d-block w-100" src={twin} alt="First slide" />
                            <Carousel.Caption>
                                <h3>Twin Room</h3>
                                <p>TV Room.</p>
                            </Carousel.Caption>
                        ...
                        <Carousel.Item>
                            <img className="d-block w-100" src={twinbed} alt="Second slide" />
                            <Carousel.Caption>
                                <h3>Twin Room</h3>
                                <p>Bedroom.</p>
                            </Carousel.Caption>
                        ...
                        <Carousel.Item>
                            <img className="d-block w-100" src={twinbath} alt="Third slide" />
                            <Carousel.Caption>
                                <h3>Twin Room</h3>
                                <p>Bathroom.</p>
                            </Carousel.Caption>
